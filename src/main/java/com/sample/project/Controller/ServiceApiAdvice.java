...
import com.sample.project.Utils.LoggerUtil;
import com.sample.project.Utils.Response;
import com.sample.project.exceptions.*;
...
@ControllerAdvice(annotations = RestController.class, basePackages = "com.test.api")
@ResponseBody
